...
**Current status correction (v1.24, 2026-08-06):** Phase 8's numbered slices P8.S1–P8.S9 are shipped; the older document-version sentence above is stale where it stops at P8.S2. The dedicated Phase 5–7 design-quality backlog has started with the account-page slice, while storefront/cart/checkout remain. `tasks.md` is the current remaining-work snapshot.
